import {
  Transition_default
} from "./chunk-C5KH2US3.js";
import {
  require_react_dom
} from "./chunk-PIBW2XQX.js";
import {
  useSlot
} from "./chunk-YTPEWP3Z.js";
import {
  debounce_default,
  ownerDocument_default,
  ownerWindow_default
} from "./chunk-JUFNR4W2.js";
import {
  useEnhancedEffect_default as useEnhancedEffect_default2,
  useEventCallback_default as useEventCallback_default2,
  useForkRef_default
} from "./chunk-ZFMOBFUM.js";
import {
  capitalize_default
} from "./chunk-TMU3U37C.js";
import {
  memoTheme_default
} from "./chunk-KQCGOV4W.js";
import {
  useDefaultProps
} from "./chunk-WDUQDZAM.js";
import {
  HTMLElementType,
  alpha,
  chainPropTypes,
...
var SwipeArea = React11.forwardRef(function SwipeArea2(props, ref) {
  const {
    anchor,
    classes = {},
    className,
  ...
  return (0, import_jsx_runtime8.jsx)(SwipeAreaRoot, {
...
true ? SwipeArea.propTypes = {
   ...
   */
  anchor: import_prop_types10.default.oneOf(["left", "top", "right", "bottom"]).isRequired,
  /**
   * @ignore
   */
...
var SwipeableDrawer = React12.forwardRef(function SwipeableDrawer2(inProps, ref) {
  const props = useDefaultProps({
  ...
  const [maybeSwiping, setMaybeSwiping] = React12.useState(false);
  const swipeInstance = React12.useRef({
    isSwiping: null
  });
  const swipeAreaRef = React12.useRef();
  const backdropRef = React12.useRef();
  const paperRef = React12.useRef();
  const handleRef = useForkRef_default(PaperProps.ref, paperRef);
  const touchDetected = React12.useRef(false);
  const calculatedDurationRef = React12.useRef();
  useEnhancedEffect_default2(() => {
    calculatedDurationRef.current = null;
  }, [open]);
  const setPosition = React12.useCallback((translate, options = {}) => {
    const {
      mode = null,
  ...
  return (0, import_jsx_runtime9.jsxs)(React12.Fragment, {
    children: [(0, import_jsx_runtime9.jsx)(Drawer_default, {
      ...
      ref,
      ...other
    }), !disableSwipeToOpen && variant === "temporary" && (0, import_jsx_runtime9.jsx)(NoSsr_default, {
      children: (0, import_jsx_runtime9.jsx)(SwipeArea_default, {
        anchor,
        ref: swipeAreaRef,
...
true ? SwipeableDrawer.propTypes = {
   ...
   * @default false
   */
  allowSwipeInChildren: import_prop_types11.default.oneOfType([import_prop_types11.default.func, import_prop_types11.default.bool]),
  /**
   * @ignore
   */
  anchor: import_prop_types11.default.oneOf(["bottom", "left", "right", "top"]),
  /**
   * The content of the component.
   */
   ...
   * @default false
   */
  disableBackdropTransition: import_prop_types11.default.bool,
  /**
   * If `true`, touching the screen near the edge of the drawer will not slide in the drawer a bit
   * to promote accidental discovery of the swipe gesture.
   * @default false
   */
  disableDiscovery: import_prop_types11.default.bool,
  /**
   * If `true`, swipe to open is disabled. This is useful in browsers where swiping triggers
   * navigation actions. Swipe to open is disabled on iOS browsers by default.
   * @default typeof navigator !== 'undefined' && /iPad|iPhone|iPod/.test(navigator.userAgent)
   */
  disableSwipeToOpen: import_prop_types11.default.bool,
  /**
   * @ignore
   */
   ...
   * @default 0.52
   */
  hysteresis: import_prop_types11.default.number,
  /**
   ...
   * @default 450
   */
  minFlingVelocity: import_prop_types11.default.number,
  /**
   * @ignore
   */
  ModalProps: import_prop_types11.default.shape({
    BackdropProps: import_prop_types11.default.shape({
   ...
   */
  SwipeAreaProps: import_prop_types11.default.object,
  /**
   * The width of the left most (or right most) area in `px` that
   * the drawer can be swiped open from.
   * @default 20
   */
  swipeAreaWidth: import_prop_types11.default.number,
  /**
   * The duration for the transition, in milliseconds.
   * You may specify a single timeout for all transitions, or individually with an object.
   * @default {
   ...
   * @ignore
   */
  variant: import_prop_types11.default.oneOf(["permanent", "persistent", "temporary"])
} : void 0;
...
//# sourceMappingURL=chunk-XQPYJ2XR.js.map
